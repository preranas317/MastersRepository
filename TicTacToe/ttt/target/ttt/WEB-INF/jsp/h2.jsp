...
<title>${player.username} playing</title>
			...
			success : function(data) {
				...
				if((!(data.checkList[m].flag)) || (data.checkList[m].msg != null)){
					...
					for(var j =0;j<3;j++){
						if(data.checkList[m].board.sarray[0][j] === 'X'){
							$("#row1").append("<td><font color='blue' size='5'>"+data.checkList[m].board.sarray[0][j]+"</font></td>");}
						else if(data.checkList[m].board.sarray[0][j] === 'X'){
							$("#row1").append("<td><font color='red' size='5'>"+data.checkList[m].board.sarray[0][j]+"</font></td>");}
						else{								
							$("#row1").append("<td><font color='blue' size='5'><a href='h2.html?k="+m+"&i=0&j="+j+"'>"+data.checkList[m].board.sarray[0][j]+"</a></font></td>");}
					}
					for(var j =0;j<3;j++){
						if(data.checkList[m].board.sarray[1][j] === 'X'){
						$("#row2").append("<td><font color='blue' size='5'>"+data.checkList[m].board.sarray[1][j]+"</font></td>");}
							...
							$("#row2").append("<td><font color='blue' size='5'><a href='h2.html?k="+m+"&i=1&j="+j+"'>"+data.checkList[m].board.sarray[1][j]+"</a></font></td>");}
					}
					for(var j =0;j<3;j++){
						if(data.checkList[m].board.sarray[2][j] === 'X'){
						$("#row3").append("<td><font color='blue' size='5'>"+data.checkList[m].board.sarray[2][j]+"</font></td>");}
							...
							$("#row3").append("<td><font color='blue' size='5'><a href='h2.html?k="+m+"&i=2&j="+j+"'>"+data.checkList[m].board.sarray[2][j]+"</a></font></td>");}
					}
				...
				if((!(data[m].flag)) || (data[m].msg != null)){
					...
					for(var j =0;j<3;j++){
						if(data[m].board.sarray[0][j] === 'X'){
							...
							$("#row1").append("<td><font color='blue' size='5'><a href='h2.html?k="+m+"&i=0&j="+j+"'>"+data[m].board.sarray[0][j]+"</a></font></td>");}
					}
					for(var j =0;j<3;j++){
						if(data[m].board.sarray[1][j] === 'X'){
						$("#row2").append("<td><font color='blue' size='5'>"+data[m].board.sarray[1][j]+"</font></td>");}
							...
							$("#row2").append("<td><font color='blue' size='5'><a href='h2.html?k="+m+"&i=1&j="+j+"'>"+data[m].board.sarray[1][j]+"</a></font></td>");}
					}
					for(var j =0;j<3;j++){
						if(data[m].board.sarray[2][j] === 'X'){
						$("#row3").append("<td><font color='blue' size='5'>"+data[m].board.sarray[2][j]+"</font></td>");}
							...
							$("#row3").append("<td><font color='blue' size='5'><a href='h2.html?k="+m+"&i=2&j="+j+"'>"+data[m].board.sarray[2][j]+"</a></font></td>");}
					}
...
<body>
<font size="6" face="Comic Sans MS">Welcome <font color="blue">${p.username}</font> </font><br><br><br><br>
